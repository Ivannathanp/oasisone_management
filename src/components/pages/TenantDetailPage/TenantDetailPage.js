...
import { useMinimalSelectStyles } from "../TenantPage/select/index";
                                    ...
                                    >
                                      <div className="contractrow">
                                        <div className="contractduration">
                                          {contractData[0].contract_Period}{" "}
                                          Years
                                        </div>
                                        ...
                                        <div className="settingslabeltext4">
                                          {moment(contractData[0].start_Date)
                                            .add(
                                              contractData[0].contract_Period,
                                              "years"
                                            )
                                      ...
                                      <div className="contractfile">
                                        ...
                                        <a
                                          href={contractData[0].contract_File}
